...
_G.packer_plugins = {
  ...
  ["fidget.nvim"] = {
    loaded = true,
    path = "/Users/daniel/.local/share/nvim/site/pack/packer/start/fidget.nvim",
  ...
  ["neodev.nvim"] = {
    loaded = true,
    path = "/Users/daniel/.local/share/nvim/site/pack/packer/start/neodev.nvim",
  ...
  ["nvim-treesitter-textobjects"] = {
    ...
    loaded = true,
    needs_bufread = false,
    path = "/Users/daniel/.local/share/nvim/site/pack/packer/opt/nvim-treesitter-textobjects",
  ...
  ["telescope-fzf-native.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = true,
    path = "/Users/daniel/.local/share/nvim/site/pack/packer/opt/telescope-fzf-native.nvim",
  ...
  ["vim-sleuth"] = {
    loaded = true,
    path = "/Users/daniel/.local/share/nvim/site/pack/packer/start/vim-sleuth",
