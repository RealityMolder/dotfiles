...
_G.packer_plugins = {
  ...
  ["alpha-nvim"] = {
    ...
    loaded = true,
    path = "/Users/daniel/.local/share/nvim/site/pack/packer/start/alpha-nvim",
  ...
  nerdcommenter = {
    loaded = true,
    path = "/Users/daniel/.local/share/nvim/site/pack/packer/start/nerdcommenter",
  ...
  ["nvim-go"] = {
    loaded = true,
    path = "/Users/daniel/.local/share/nvim/site/pack/packer/start/nvim-go",
    url = "https://github.com/jpmcb/nvim-go"
  },
  ["nvim-lsp-ts-utils"] = {
    loaded = true,
    path = "/Users/daniel/.local/share/nvim/site/pack/packer/start/nvim-lsp-ts-utils",
  ...
  ["nvim-neoclip.lua"] = {
    ...
    loaded = true,
    path = "/Users/daniel/.local/share/nvim/site/pack/packer/start/nvim-neoclip.lua",
  ...
  ["rust-tools.nvim"] = {
    loaded = true,
    path = "/Users/daniel/.local/share/nvim/site/pack/packer/start/rust-tools.nvim",
  ...
  ["vim-gitgutter"] = {
    loaded = true,
    path = "/Users/daniel/.local/share/nvim/site/pack/packer/start/vim-gitgutter",
  ...
  ["vim-visual-multi"] = {
    loaded = true,
    path = "/Users/daniel/.local/share/nvim/site/pack/packer/start/vim-visual-multi",
